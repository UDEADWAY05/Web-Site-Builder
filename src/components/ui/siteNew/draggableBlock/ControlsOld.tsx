...
import { updateBlockContent,deleteBlock,updateBlockPosition } from 'src/store/slices/layoutSite/layoutSiteSlice'
...
export function Controls({ block, onSave: onMouseLeave, onCancel }:ControlsProps) {
