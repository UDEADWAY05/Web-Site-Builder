...
export const SignUp = () => {
    ...
    const { formState:{ errors,isDirty,isValid,isSubmitting },setError} = form
    ...
    <form onSubmit={form.handleSubmit(onSubmit) } className="px-2 py-4 flex flex-col sm:w-1/2 md:w-1/3 gap-1">
        <FormInputField form={form} name={'email'} label='Email' type='text' placeholder='email'/> 
        <FormInputField form={form} name={'name'} label='Имя' type='text' placeholder='имя'/> 
        <FormInputField form={form} name={'surname'} label='Фамилия' type='text' placeholder='фамилия'/> 
        <FormInputField form={form} name={'password'} label='Пароль' type='password' placeholder='пароль'/> 
        <FormInputField form={form} name={'confirmPassword'} label='Подтвердите пароль' type='password' placeholder='подтвердите пароль'/> 
